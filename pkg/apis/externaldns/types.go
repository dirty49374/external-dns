...
func (cfg *Config) ParseFlags(args []string) error {
	...
	app.Flag("interval-error", "The interval when last synchronizations was error in duration format (default: 0)").Default(defaultConfig.IntervalError.String()).DurationVar(&cfg.IntervalError)
